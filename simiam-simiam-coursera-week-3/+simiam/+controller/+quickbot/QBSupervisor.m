    ...
    %% METHODS
        ...
        function [vel_r, vel_l] = ensure_w(obj, robot, v, w)
            ...
            if (vel_rl_max > obj.robot.max_vel)
                redterm = vel_rl_max - obj.robot.max_vel;
                vel_r = vel_r_d - redterm;
                vel_l = vel_l_d - redterm;
            elseif (vel_rl_min < -obj.robot.max_vel)
                redterm2 = vel_rl_min + obj.robot.max_vel;
                vel_r = vel_r_d - redterm2;
                vel_l = vel_l_d - redterm2;
            else
                vel_r = vel_r_d;
                vel_l = vel_l_d;
            end
